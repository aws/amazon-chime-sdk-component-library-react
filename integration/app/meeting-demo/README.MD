...
This is the SDK react meeting app that is used for manual testing during development and QA testing.
For a React meeting demo, please refer to the [React meeting demo sample](https://github.com/aws-samples/amazon-chime-sdk/tree/main/apps/meeting) in our aws samples repo.
