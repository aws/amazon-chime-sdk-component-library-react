...
describe('Radio', () => {
  ...
  it('should render a Radio with HiddenRadio component in the document', () => {
    const component = <Radio value={value} onChange={mockFunction} label={label} />
    const { getByTestId } = renderWithTheme(lightTheme, component);
    const hiddenRadio = getByTestId('hiddenRadio');

    expect(hiddenRadio).toBeInTheDocument();
  });

  it('should render a Radio with styledRadio component in the document', () => {
    const component = <Radio value={value} onChange={mockFunction} label={label} />
    const { getByTestId } = renderWithTheme(lightTheme, component);
    const styledRadio = getByTestId('styledRadio');
  ...
  it('should render a unchecked radio', () => {
    const component = <Radio value={value} onChange={mockFunction} label={label} checked={false} />
    const { getByTestId } = renderWithTheme(lightTheme, component);
    const hiddenRadio = getByTestId('hiddenRadio');
  ...
  it('should render a checked Radio', () => {
    const component = <Radio value={value} onChange={mockFunction} checked label={label} />
    const { getByTestId } = renderWithTheme(lightTheme, component);
    const hiddenRadio = getByTestId('hiddenRadio');
