...
The VideoGrid component adapts to screen size and orientation, ensuring consistent rendering of up to 16 [VideoTiles](/docs/ui-components-video-videotile--video-tiles).
