...
6. _Optional_ - How to enable logging in Chime React Component Library?

You have to use `LoggerProvider` to enable logging from Chime React Component Library. Please check [LoggerProvider](/story/sdk-providers-loggerprovider--page)
and [useLogger](/story/sdk-hooks-uselogger--page) documentation for more information.

7. _Optional_ - How to enable a meeting to post Amazon Chime SDK for JavaScript logs to a URL?
...
8. _Optional_ - Opt-out of client event ingestion
...
9. _Optional_ - Receive Amazon Chime SDK Meeting Events
