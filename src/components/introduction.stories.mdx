...
1. Add `StyledComponents` and `amazon-chime-sdk-component-library-react` dependencies to your project
...
5. Optional - adding attendee names

Chime does not manage the names of your attendees. If you want nameplates or a realtime roster, you need to provide a function to `meetingManager.getAttendee` that returns the name of the attendee for a given chime attendee ID and external user ID.
