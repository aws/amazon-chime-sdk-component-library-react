...
The `useDeviceLabelTriggerStatus` hook returns the [`DeviceLabelTrigger`](https://github.com/aws/amazon-chime-sdk-js/blob/main/src/devicecontroller/DeviceControllerFacade.ts#L25) status from the enum below.
