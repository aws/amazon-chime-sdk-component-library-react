...
**Please note** - This hook is deprecated and will be removed in future version, please use `useMediaStreamMetrics` to get the available outgoing and incoming bandwidth for the current meeting session.
