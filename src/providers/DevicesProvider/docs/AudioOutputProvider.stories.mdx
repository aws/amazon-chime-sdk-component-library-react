...
Provides a list of the user's available `audio-output` devices and the currently selected device.
...
You can access the provided values using [useAudioOutputs](/?path=/docs/sdk-hooks-useaudiooutputs--page) hook.
...
import { MeetingProvider, useAudioOutputs } from 'amazon-chime-sdk-component-library-react';
