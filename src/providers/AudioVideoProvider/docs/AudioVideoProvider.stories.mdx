<Meta title="Providers/AudioVideoProvider" />

# AudioVideoProvider

Provides the meeting session's [AudioVideo instance](https://aws.github.io/amazon-chime-sdk-js/interfaces/audiovideofacade.html) to the application. This instance is used internally by our components and hooks, but is also available if you need to set up your own observers to the Chime JS SDK.
