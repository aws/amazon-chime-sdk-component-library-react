...
Returns state and functionality around starting, stopping, pausing, and unpausing the local user's content share.
...
import { MeetingProvider, useContentShareControls } from 'amazon-chime-sdk-component-library-react';
